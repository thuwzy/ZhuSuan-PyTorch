...
class MaskCoupling(RevNet):
    ...
    :param mask: mask given by the user, often generated by function:`~zhusuan.invertible.coupling.get_coupling_mask`
    """

    def __init__(self, in_out_dim=-1, mid_dim=-1, hidden=-1, mask=None, inner_nn=None):
        super(MaskCoupling, self).__init__()
        if inner_nn is None:
            self.nn = []
